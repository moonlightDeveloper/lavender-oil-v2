            ...
            <div className="wrap-contact2">
                <form className="contact2-form validate-form" onSubmit={handleSubmit}>
                    ...
                    <div className="form-fetch-info">
                        {showSuccess &&
                            <svg id="successAnimation" className="animated" xmlns="http://www.w3.org/2000/svg" width="200" height="200" viewBox="0 0 70 70">
                        ...
                        {showFail &&
                            <svg id="failureAnimation" className="animated" xmlns="http://www.w3.org/2000/svg" width="200" height="200" viewBox="0 0 70 70">
                                <circle id="failureAnimationCircle" cx="35" cy="35" r="24" stroke="#005596" stroke-width="2" stroke-linecap="round" fill="transparent" />
                                <polyline className="failureAnimationCheckLine" stroke="#005596" stroke-width="2" points="25,25 45,45" fill="transparent" />
                                <polyline className="failureAnimationCheckLine" stroke="#005596" stroke-width="2" points="45,25 25,45" fill="transparent" />
                            </svg>}
                    </div>
