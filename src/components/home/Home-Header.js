                            ...
                            <div className="container main-container">
                                <div className="col-sm-12 header-lav">
                                    <div className="carousel-content centered">
                                        <h2 className="boxed animation animated-item-1 fade-down header-title">{t('home-page.main-title-first-line')} <br/> {t('home-page.main-title-second-line')} <br/> <h4 className="manifacturer">{t('home-page.main-subtitele1')}</h4> </h2>
                                        <br/>
